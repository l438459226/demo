...
void SSD_LANE(u8 lane,u16 clock)
{
	...
	if(clock)
		...
		Write_SSPI_REG(0xBA, dsi_clock(panel_info.pclk*24/panel_info.dsi_lane + 8));
	Write_SSPI_REG(0xDE, (lane-1));	//LANE  0--1 lane  1--2 lane  2--3 lane  3--4 lane
	delay_ms(10);
	//Write_SSPI_REG(0x00B9,0x0001);
	printf("brige B9:0x%x",ssd_rdata(0xB9));
	delay_ms(100);
}
...
// 	panel_info.width = 720;
// 	panel_info.height = 1080;
// 	panel_info.pixel = 24;
// 	panel_info.fps = 56;		//60??
// 	
// 	panel_info.hsync = 4;
// 	panel_info.hbp = 16;
// 	panel_info.hfp = 24;
...
// 	
// 	panel_info.pclk = panel_info.fps * ((panel_info.width + panel_info.hsync + panel_info.hbp + panel_info.hfp) * (panel_info.height + panel_info.vsync + panel_info.vbp + panel_info.vfp))/1000000;
// 	panel_info.dsi_mbps = panel_info.pclk*24/panel_info.dsi_lane + 8;		//?8m????
// 	
	
	SSD_LANE(4,950);
/*
	DCS_Short_Write_1P(0x00, 0x00);
	DCS_Long_Write_3P(0xFF, 0x87, 0x19, 0x01);	//8A

	DCS_Short_Write_1P(0x00, 0x80);
	DCS_Long_Write_2P(0xFF, 0x87, 0x19);
	// Set BD
	DCS_Short_Write_1P(0x00, 0x90);
	
	DCS_Short_Write_1P(0xF6, 0x90);


	DCS_Short_Write_1P(0x11,0x00);
	DCS_Short_Write_1P(0x35,0x00);
	DCS_Short_Write_1P(0x51,0x80);
	DCS_Short_Write_1P(0x53,0x24);
	DCS_Short_Write_1P(0x55,0x00);
	delay_ms(150);
	DCS_Short_Write_1P(0x29,0x00);
	delay_ms(20);
