...
void yassylcd_init(void)
{
  ...
  SSD_RESET = 1;
	...
	Write_SSPI_REG(0xBA, 0xC238);//
	Write_SSPI_REG(0xBB, 0x000F);//
	Write_SSPI_REG(0xBC, 0x0001);//
	Write_SSPI_REG(0xBF, 0x00E3);

	Write_SSPI_REG(0xC1, 0x0006);
	Write_SSPI_REG(0xC6, 0xC1C6);
	Write_SSPI_REG(0xC7, 0x0010);
	
	Write_SSPI_REG(0xC9, 0x220B);
	Write_SSPI_REG(0xCA, 0x4F0E);
	Write_SSPI_REG(0xCB, 0x0322);
	Write_SSPI_REG(0xCC, 0x1214);
//	Write_SSPI_REG(0xCD, 0x2CC4);

//	Write_SSPI_REG(0xD5, 0x30C0);
	Write_SSPI_REG(0xDE, 0x0003);
	Write_SSPI_REG(0xDF, 0x001E);
	Write_SSPI_REG(0xB9, 0x0001);//


	DCS_Short_Write_1P(0x35,0x00);
	DCS_Short_Write_1P(0x51,0x80);
	DCS_Short_Write_1P(0x53,0x20);
...
// 	Write_SSPI_REG(0xB5, panel_info.height);				//
	Write_SSPI_REG(0xB1, 0x0202);			//VSA  HAS
	Write_SSPI_REG(0xB2,0x0E2A);			//VBP+10 HBP						
	Write_SSPI_REG(0xB3, 0x196E);			//VFP HFP								
	Write_SSPI_REG(0xB4, 0x0438);				//						        	
	Write_SSPI_REG(0xB5, 0X500);				//
