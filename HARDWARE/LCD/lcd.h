...
#define	LCD_CS_SET  		GPIO_SetBits(GPIOB,GPIO_Pin_11)    //片选端口  		PB11
#define	LCD_RESET_SET		GPIO_SetBits(GPIOB,GPIO_Pin_12)    //数据/命令 		PB12	  
#define	LCD_RS_SET			GPIO_SetBits(GPIOB,GPIO_Pin_13)    //数据/命令 		PB13	   
#define	LCD_WR_SET			GPIO_SetBits(GPIOB,GPIO_Pin_14)    //写数据				PB14
#define	LCD_RD_SET			GPIO_SetBits(GPIOB,GPIO_Pin_15)    //读数据				PB15
								    
#define	LCD_CS_CLR  		GPIO_ResetBits(GPIOB,GPIO_Pin_11)   //片选端口  		PB11
#define	LCD_RESET_CLR		GPIO_ResetBits(GPIOB,GPIO_Pin_12)    //数据/命令 		PB12	  
#define	LCD_RS_CLR			GPIO_ResetBits(GPIOB,GPIO_Pin_13)    //数据/命令		PB13	   
#define	LCD_WR_CLR			GPIO_ResetBits(GPIOB,GPIO_Pin_14)    //写数据				PB14
#define	LCD_RD_CLR			GPIO_ResetBits(GPIOB,GPIO_Pin_15)   //读数据				PB15  
...
#define LCD_WR_DATA(data)   	LCD_WR_DATAX(data)
