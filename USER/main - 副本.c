...
// 	for(i=0xB0;i<0XF7;i++)
// 	{
// 		printf(" 0x%x=0x%x ",i,ssd_rdata(i));
// 	}
// 	printf("\r\n\r\n");
// 	 
// 	 
...
Write_SSPI_REG(0xD6,0x0005);
Write_SSPI_REG(0xB9,0xC000);
Write_SSPI_REG(0xBA,0xC34C);
Write_SSPI_REG(0xCF,0x0000);
Write_SSPI_REG(0xD0,0x0010);
Write_SSPI_REG(0xDE,0x0003);
Write_SSPI_REG(0xBB,0x0007);
Write_SSPI_REG(0xD5,0x30C0);
Write_SSPI_REG(0xCE,0x0405);
Write_SSPI_REG(0xCD,0x2E64);
Write_SSPI_REG(0xCC,0x0B0F);
Write_SSPI_REG(0xCB,0x083F);
Write_SSPI_REG(0xCA,0x2F06);
Write_SSPI_REG(0xC9,0x1709);
...
Write_SSPI_REG(0xB1,0x0A04);
Write_SSPI_REG(0xB2,0x1A10);
Write_SSPI_REG(0xB3,0x0418);
Write_SSPI_REG(0xB4,0x0438);
Write_SSPI_REG(0xB9,0x0924);
